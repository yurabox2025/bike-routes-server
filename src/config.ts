...
export const config = {
  ...
  yadiskToken: process.env.YADISK_TOKEN ?? process.env.RENDER_YADISK_TOKEN ?? '',
  yadiskBaseDir: process.env.YADISK_BASE_DIR ?? process.env.RENDER_YADISK_BASE_DIR ?? '/bike-app',
  yadiskDataPath: process.env.YADISK_DATA_PATH ?? process.env.RENDER_YADISK_DATA_PATH ?? '/bike-app/data/data.json',
  dataStorageProvider,
